            ...
            <Modal width='40%' onClose={this.modalClose}>
                ...
                <Modal.Body>
                    <p>Мы в IT-сообществе RndTech сделали исследование узнаваемости брендов IT-компаний в Ростове и
                        Таганроге.
                        Мы рассказали о нашей анкете 25 раз, а заполнили анкету больше 700 человек, теперь мы спешим
                        поделиться с вами результатами.</p>
                    ...
                    <p>Например, можно посмотреть, где хотят работать джависты, 
                        или куда мечтают устроиться студенты Таганрога.
