            ...
            <Modal width='40%' onClose={this.modalClose}>
                ...
                <Modal.Body>
                    <p>Мы в IT-сообществе RndTech сделали исследование узнаваемости брендов IT-компаний в Ростове и
                        Таганроге.
                        Вы рассказали о нашей анкете 25 раз (и этот опрос стал возможен именно благодаря вам), 
                        а заполнили анкету больше 700 человек. И мы спешим поделиться результатами с вами.
                    </p>
